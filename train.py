...
parser.add_argument(
    ...
    '--batch-size', '-N', type=int, default=25, help='batch size')
    #'--batch-size', '-N', type=int, default=25, help='batch size')
    #'--batch-size', '-N', type=int, default=35, help='batch size')
    #'--batch-size', '-N', type=int, default=50, help='batch size')
    #'--batch-size', '-N', type=int, default=5, help='batch size')
parser.add_argument(
...
parser.add_argument(
    ...
    #'--max-epochs', '-e', type=int, default=30, help='max epochs')
    #'--max-epochs', '-e', type=int, default=20, help='max epochs')
parser.add_argument('--lr', type=float, default=0.0005, help='learning rate')
parser.add_argument('--cuda', '-g', action='store_true', help='enables cuda')
parser.add_argument(
    #'--iterations', type=int, default=32, help='unroll iterations')
    '--iterations', type=int, default=16, help='unroll iterations')
    #'--iterations', type=int, default=10, help='unroll iterations')
    #'--iterations', type=int, default=5, help='unroll iterations')
